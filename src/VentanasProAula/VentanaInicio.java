...
import manejoDatos.EstudianteDAO;
...
IAccesoDatos estudianteDAO = new EstudianteDAO();
    ...
    public void validar(){
        ...
        if(user.equals("") ||  contra.equals("")){
            ...
            l = loginDAO.validar(user, contra);
    ...
    public void registrar (){
        ...
        String user = nombre + "_2023";
        String clave = identificacion;
        Estudiante estudiante = new Estudiante(nombre, apellido, semestre, identificacion, correo, user, clave);
